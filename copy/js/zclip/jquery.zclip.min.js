...
(function(a) { a.fn.zclip = function(c) {
        if (typeof c == "object" && !c.length) {
            var b = a.extend({ path: "/js/ZeroClipboard.swf", copy: null, beforeCopy: null, afterCopy: null, clickAfter: true, setHandCursor: true, setCSSEffects: true }, c);
...
var ZeroClipboard = { version: "1.0.7", clients: {}, moviePath: "/js/ZeroClipboard.swf", nextId: 1, $: function(a) {
