...
if (!hs) {
    var hs = {
        ...
        lang: {
            ...
            fullExpandText: '1:1',
            number: '图片 %1 of %2',
            restoreTitle: '点击底部的图标可以关闭/拖动/浏览上一张下一张.'
        },
    ...
    hs.Expander.prototype = {
        ...
        changeSize: function(up, to, dur) {
            ...
            var trans = this.transitions,
                ...
                t = (trans[1] && other && hs.getParam(other, 'transitions')[1] == trans[1]) ?
                trans[1] : trans[0];
        ...
        showHideElements: function(tagName, visibility) {
            ...
            for (var i = 0; i < els.length; i++) {
                if (prop == 'visibility' || (document.defaultView.getComputedStyle(
                        els[i], "").getPropertyValue('overflow') == 'auto' || els[i].getAttribute('hidden-by') != null)) {
